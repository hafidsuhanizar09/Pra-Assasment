...
import com.d3if4201.pra_assesment.databinding.FragmentSegitigaBinding
...
class SegtigaFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        binding.Share.setOnClickListener {
            LuasSegitiga.text.toString()
            KelilingSegitiga.text.toString()
    ...
    @SuppressLint("SetTextI18n")
    private fun updateNilai(s2: Double, s3: Double) {
